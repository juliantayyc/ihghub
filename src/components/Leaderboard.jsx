...
const Leaderboard = () => {
    ...
    return (
        <div id="leaderboard" className='container' style={{scrollMarginTop: "120px"}}>
            <div class="relative z-1 flex flex-col items-center mb-10 mt-10 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 bg-purple-500 bg-opacity-10">
